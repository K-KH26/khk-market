...
if($has_var){
    ...
    */
    ...
    $detail_history_arraylist = $search_list->getDetailHistoryList($detail_search_list);

    //리스트 Table view 생성하기
    include ('../main_index/VIEW/view-search.php');
    $view = new ViewSearch;
    if($detail_history_arraylist){
        $detail_table = $view->makeHistoryTable($detail_history_arraylist);
    }else{
